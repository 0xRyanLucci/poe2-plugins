...
cd /home/ryan/.local/share/pipx/venvs/poe2-mcp/lib/python3.12/site-packages
exec /home/ryan/.local/share/pipx/venvs/poe2-mcp/bin/python -m src.mcp_server 2>/dev/null
